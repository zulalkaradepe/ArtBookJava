package com.zulalkaradepe.artbookjava;
...
import com.zulalkaradepe.artbookjava.databinding.ActivityArtBinding;
...
public class ArtActivity extends AppCompatActivity {
    ...
    ActivityResultLauncher<String> permissionLauncher; //izini istmek için
    ...
    public void selectImage(View view) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            //Android 32 ve altı -> READ_EXTERNAL_IMAGES
